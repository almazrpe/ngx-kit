        ...
        this.checkFunc!(files).pipe(
            ...
            next: (acceptedFiles: UploadFileObject[]) => {
                const acceptedFilenames: Set<string> =
                    new Set(
                        acceptedFiles.map(
                            (obj: UploadFileObject) => obj.file.name
                        )
                    );
                            ...
                            this.alertService.spawn({
                                ...
                                msg:
                                    `«${
                                        ...
                                        this._config_.filenameRepeatTranslation
                                    }`
                            });
                            return false;
                        } else
                ...
                this.alertService.spawn({
                    ...
                    msg:
                        `«${
                            ...
                            this._config_.unknownExtensionTranslation
                        }`
                });
                return false;
            } else {
                    ...
                    this.alertService.spawn({
                        ...
                        msg:
                            `«${
                                ...
                                this._config_.wrongExtensionTranslation
                            }`
                    });
                    return false;
                } else
